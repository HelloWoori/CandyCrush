...
public class Dot : MonoBehaviour
{
    ...
    void CalculateAngle()
    {
        ...
        {
            swipeAngle = Mathf.Atan2(finalTouchPosition.y - firstTouchPosition.y, finalTouchPosition.x - firstTouchPosition.x) * Mathf.Rad2Deg; //180 / Mathf.PI                                                                                                                                         //Debug.Log(swipeAngle);
            MovePieces();
        }
    }
